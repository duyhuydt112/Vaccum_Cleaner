...
#include "tutorial_service/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_service::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_service::msg::Sphere & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const tutorial_service::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_service::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &tutorial_service::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_service, msg, Sphere)() {
  return &tutorial_service::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
