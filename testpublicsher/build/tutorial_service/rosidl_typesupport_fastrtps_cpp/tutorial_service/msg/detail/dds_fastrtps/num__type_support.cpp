...
#include "tutorial_service/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tutorial_service::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_service::msg::Num *>(
    untyped_ros_message);
...
{
  return &tutorial_service::msg::typesupport_fastrtps_cpp::_Num__handle;
}
